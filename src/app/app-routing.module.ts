...
const routes: Routes = [
  ...
  { path: 'licenses', loadChildren: () => import('./features/license/license.module')
  .then(m => m.LicenseModule), },
  { path: 'emr-design', loadChildren: () => import('./pages/template-design/template-design.module').then(m => m.TemplateDesignModule) }  */
